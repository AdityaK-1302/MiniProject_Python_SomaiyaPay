...
def Menu():
    ...
    while(1):
        ...
        print("3. Balance")
        print("4. Logout")
        choice2 = input("Please select the number choice corresponding to the task you want to perform: ")
        if(choice2=='1'):
            b = 1
            Add()
        if(choice2=='2'):
            ...
            while(1):
                print("1. Stationary")
                print("2. Canteen")
                choice3 = input("Please select the number choice corresponding to the place you want to purchase from: ")
                if(choice3=='1'):
                    Stationary()
                    break
                if(choice3=='2'):
...
while(1):
    ...
    print("2. Login")
    print("3. Exit")
    choice1 = input("Please select the number choice corresponding to the task you want to perform: ")
    while(1):
        if(choice1 == '1'):
            a = 1 
            if(Register() == 1):
        ...
        if(choice1 == '2'):
            ...
            if(Login() == 1):
                ...
                print("There are no such Registered Users!")
                break
        if(choice1 == '3'):
