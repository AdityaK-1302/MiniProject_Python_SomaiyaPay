    ...
    if ((Login() == 0)):
        if (len(r.roll) == 0):
            ...
            messagebox.showerror(
                "ERROR",
                "There are no Registered Users with this Roll Number!")
        return
...
def Register():
    ...
    Label(screen,
          ...
          font=("BankGothic Lt BT", 20, "bold")).place(x=50, y=50)
...
def Menu():
    Button(screen,
           text="Add Money",
           font=("BankGothic Lt BT", 18),
           command=Add).place(x=50, y=50)
    Button(screen,
           text="Purchase",
           font=("BankGothic Lt BT", 18),
           command=CheckP).place(x=50, y=110)
    Button(screen,
           text="Balance",
           font=("BankGothic Lt BT", 18),
           command=r.display).place(x=50, y=170)
    Button(screen, text="Logout", font=("BankGothic Lt BT", 18),
           command=Mains).place(x=50, y=230)
...
def CheckP():
    Button(screen,
           text="Stationary",
           font=("BankGothic Lt BT", 18),
           command=Stationary).place(x=50, y=50)
    Button(screen,
           text="Canteen",
           font=("BankGothic Lt BT", 18),
           command=Canteen).place(x=50, y=110)
...
def Mains():
    Button(screen,
           text="Register",
           font=("BankGothic Lt BT", 18),
           command=CheckR).place(x=50, y=150)
    Button(screen, text="Login", font=("BankGothic Lt BT", 18),
           command=CheckL).place(x=50, y=210)
    Button(screen, text="Exit", font=("BankGothic Lt BT", 18),
           command=Exit).place(x=50, y=270)
...
text1 = Label(text="SomaiyaPay",
              bg='Red',
              fg='Black',
              padx=233,
              pady=4,
              font=("BankGothic Lt BT", 18, "bold"),
              borderwidth=3).pack(fill=X)
text2 = Label(text="   ", bg='Red', borderwidth=3).pack(side=LEFT, fill=Y)
Label(screen,
      text="WELCOME TO SOMAIYA PAY",
      font=("BankGothic Lt BT", 20, "bold")).place(x=325, y=50)
Label(screen,
      text="What Would You Like to Do Today? ",
      font=("BankGothic Lt BT", 18, "bold")).place(x=50, y=100)
r = user()
Mains()
